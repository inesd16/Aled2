...
class form7 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Seekbar1 = findViewById(R.id.form7_seekBar1)
        Seekbar4 = findViewById(R.id.form7_seekBar4)
        Switch2 = findViewById(R.id.form7_switch2)
        Switch3 = findViewById(R.id.form7_switch3)
        Switch5 = findViewById(R.id.form7_switch5)
        Go = findViewById(R.id.form7_button1)
        val form = intent
