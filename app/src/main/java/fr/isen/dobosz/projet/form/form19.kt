...
class form19 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Seekbar1 = findViewById(R.id.form19_seekBar1)
        Switch2 = findViewById(R.id.form19_switch2)
        Switch3 = findViewById(R.id.form19_switch3)
        Switch4 = findViewById(R.id.form19_switch4)
        Switch5 = findViewById(R.id.form19_switch5)
        Switch6 = findViewById(R.id.form19_switch6)
        Go = findViewById(R.id.form19_button1)
        val form = intent
