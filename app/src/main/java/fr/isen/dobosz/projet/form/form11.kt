...
class form11 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Seekbar1 = findViewById(R.id.form11_seekBar1)
        Seekbar4 = findViewById(R.id.form11_seekBar4)
        Switch2 = findViewById(R.id.form2_switch2)
        Switch3 = findViewById(R.id.form2_switch3)
        Switch5 = findViewById(R.id.form2_switch5)
        Go = findViewById(R.id.form11_button1)
        val form = intent
