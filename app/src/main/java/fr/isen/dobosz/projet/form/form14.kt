...
class form14 : AppCompatActivity() {
    ...
    private var Switch6: Switch? = null
    private var Go: Button? = null
    private var ret1 = 0
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_form14)
        Seekbar1 = findViewById(R.id.form14_seekBar1)
        Seekbar2 = findViewById(R.id.form14_seekBar2)
        Switch3 = findViewById(R.id.form14_switch3)
        Switch4 = findViewById(R.id.form14_switch4)
        Switch5 = findViewById(R.id.form14_switch5)
        Switch6 = findViewById(R.id.form14_switch6)
        Go = findViewById(R.id.form14_button1)
        val form = intent
