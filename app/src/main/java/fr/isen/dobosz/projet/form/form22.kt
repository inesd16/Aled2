...
class form22 : AppCompatActivity() {
        ...
        button.setOnClickListener(object : View.OnClickListener{
            override fun onClick(v: View?) {
                when (ret1 /*Log.d("ret1", extras?.getInt("val").toString())*/) {
                    1 -> {
                        saveData()
                        writeFile(text122.text.toString(), text222.text.toString(), text322.text.toString(), this)
                        read()
                        val form1Activity = Intent(this@form22, form1::class.java)
                    ...
                    2 -> {
                        ...
                        writeFile(text122.text.toString(), text222.text.toString(), text322.text.toString(), this)
                        read()
                        val form2Activity = Intent(this@form22, form2::class.java)
                    ...
                    3 -> {
                        ...
                        writeFile(text122.text.toString(), text222.text.toString(), text322.text.toString(), this)
                        read()
                        val form3Activity = Intent(this@form22, form3::class.java)
                    ...
                    4 -> {
                        ...
                        writeFile(text122.text.toString(), text222.text.toString(), text322.text.toString(), this)
                        read()
                        val form4Activity = Intent(this@form22, form4::class.java)
                    ...
                    5 -> {
                        ...
                        writeFile(text122.text.toString(), text222.text.toString(), text322.text.toString(), this)
                        read()
                        val form5Activity = Intent(this@form22, form5::class.java)
                    ...
                    6 -> {
                        ...
                        writeFile(text122.text.toString(), text222.text.toString(), text322.text.toString(), this)
                        read()
                        val form6Activity = Intent(this@form22, form6::class.java)
                    ...
                    7 -> {
                        ...
                        writeFile(text122.text.toString(), text222.text.toString(), text322.text.toString(), this)
                        read()
                        val form7Activity = Intent(this@form22, form7::class.java)
                    ...
                    8 -> {
                        ...
                        writeFile(text122.text.toString(), text222.text.toString(), text322.text.toString(), this)
                        read()
                        val form8Activity = Intent(this@form22, form8::class.java)
                    ...
                    9 -> {
                        ...
                        writeFile(text122.text.toString(), text222.text.toString(), text322.text.toString(), this)
                        read()
                        val form9Activity = Intent(this@form22, form9::class.java)
                    ...
                    10 -> {
                        ...
                        writeFile(text122.text.toString(), text222.text.toString(), text322.text.toString(), this)
                        read()
                        val form10Activity = Intent(this@form22, form10::class.java)
                    ...
                    11 -> {
                        ...
                        writeFile(text122.text.toString(), text222.text.toString(), text322.text.toString(), this)
                        read()
                        val form11Activity = Intent(this@form22, form11::class.java)
                    ...
                    12 -> {
                        ...
                        writeFile(text122.text.toString(), text222.text.toString(), text322.text.toString(), this)
                        read()
                        val form12Activity = Intent(this@form22, form12::class.java)
                    ...
                    13 -> {
                        ...
                        writeFile(text122.text.toString(), text222.text.toString(), text322.text.toString(), this)
                        read()
                        val form13Activity = Intent(this@form22, form13::class.java)
                    ...
                    14 -> {
                        ...
                        writeFile(text122.text.toString(), text222.text.toString(), text322.text.toString(), this)
                        read()
                        val form14Activity = Intent(this@form22, form14::class.java)
                    ...
                    15 -> {
                        ...
                        writeFile(text122.text.toString(), text222.text.toString(), text322.text.toString(), this)
                        read()
                        val form15Activity = Intent(this@form22, form15::class.java)
                    ...
                    16 -> {
                        ...
                        writeFile(text122.text.toString(), text222.text.toString(), text322.text.toString(), this)
                        read()
                        val form16Activity = Intent(this@form22, form16::class.java)
                    ...
                    17 -> {
                        ...
                        writeFile(text122.text.toString(), text222.text.toString(), text322.text.toString(), this)
                        read()
                        val form17Activity = Intent(this@form22, form17::class.java)
                    ...
                    18 -> {
                        ...
                        writeFile(text122.text.toString(), text222.text.toString(), text322.text.toString(), this)
                        read()
                        val form18Activity = Intent(this@form22, form18::class.java)
                    ...
                    19 -> {
                        ...
                        writeFile(text122.text.toString(), text222.text.toString(), text322.text.toString(), this)
                        read()
                        val form19Activity = Intent(this@form22, form19::class.java)
                    ...
                    20 -> {
                        ...
                        writeFile(text122.text.toString(), text222.text.toString(), text322.text.toString(), this)
                        read()
                        val form20Activity = Intent(this@form22, form20::class.java)
                    ...
                    21 -> {
                        ...
                        writeFile(text122.text.toString(), text222.text.toString(), text322.text.toString(), this)
                        read()
                        val form21Activity = Intent(this@form22, form21::class.java)
                    ...
                    22 -> {
                        ...
                        writeFile(text122.text.toString(), text222.text.toString(), text322.text.toString(), this)
                        read()
                        val form22Activity = Intent(this@form22, form22::class.java)
    ...
    fun read() {
        requestPermission(Manifest.permission.READ_EXTERNAL_STORAGE, form20.readESRequestCode) {
            val root = getExternalFilesDir("DataToSend")
            val dir = File(root!!.absolutePath)
            val file = File(dir, "answerForm22.txt")
