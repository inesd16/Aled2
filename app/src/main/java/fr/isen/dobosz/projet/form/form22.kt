...
class form22 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Seekbar1 = findViewById(R.id.form22_seekBar1)
        Switch2 = findViewById(R.id.form22_switch2)
        Seekbar3 = findViewById(R.id.form22_seekBar3)
        Switch4 = findViewById(R.id.form22_switch4)
        Switch5 = findViewById(R.id.form22_switch5)
        Go = findViewById(R.id.form22_button1)
        val form = intent
