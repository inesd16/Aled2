...
class form8 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Seekbar1 = findViewById(R.id.form8_seekBar1)
        Seekbar2 = findViewById(R.id.form8_seekBar2)
        Seekbar3 = findViewById(R.id.form8_seekBar3)
        Switch4 = findViewById(R.id.form2_switch4)
        Switch5 = findViewById(R.id.form2_switch5)
        Go = findViewById(R.id.form8_button1)
        val form = intent
