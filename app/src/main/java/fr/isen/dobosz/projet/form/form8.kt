...
import kotlinx.android.synthetic.main.activity_form8.*
import kotlinx.android.synthetic.main.activity_form8.button
import org.json.JSONObject
import java.io.File
import java.io.FileNotFoundException
import java.io.IOException

class form8 : AppCompatActivity() {
    private var ret1 = 0
    companion object{
        ...
        button.setOnClickListener(object : View.OnClickListener{
            override fun onClick(v: View?) {
                when (ret1) {
                    1 -> {
                        saveData()
                        writeFile(text18.text.toString(), text28.text.toString(), this)
                        read()
                        val form1Activity = Intent(this@form8, form1::class.java)
                    ...
                    2 -> {
                        ...
                        writeFile(text18.text.toString(), text28.text.toString(), this)
                        read()
                        val form2Activity = Intent(this@form8, form2::class.java)
                    ...
                    3 -> {
                        ...
                        writeFile(text18.text.toString(), text28.text.toString(), this)
                        read()
                        val form3Activity = Intent(this@form8, form3::class.java)
                    ...
                    4 -> {
                        ...
                        writeFile(text18.text.toString(), text28.text.toString(), this)
                        read()
                        val form4Activity = Intent(this@form8, form4::class.java)
                    ...
                    5 -> {
                        ...
                        writeFile(text18.text.toString(), text28.text.toString(), this)
                        read()
                        val form5Activity = Intent(this@form8, form5::class.java)
                    ...
                    6 -> {
                        ...
                        writeFile(text18.text.toString(), text28.text.toString(), this)
                        read()
                        val form6Activity = Intent(this@form8, form6::class.java)
                    ...
                    7 -> {
                        ...
                        writeFile(text18.text.toString(), text28.text.toString(), this)
                        read()
                        val form7Activity = Intent(this@form8, form7::class.java)
                    ...
                    8 -> {
                        ...
                        writeFile(text18.text.toString(), text28.text.toString(), this)
                        read()
                        val form8Activity = Intent(this@form8, form8::class.java)
                    ...
                    9 -> {
                        ...
                        writeFile(text18.text.toString(), text28.text.toString(), this)
                        read()
                        val form9Activity = Intent(this@form8, form9::class.java)
                    ...
                    10 -> {
                        ...
                        writeFile(text18.text.toString(), text28.text.toString(), this)
                        read()
                        val form10Activity = Intent(this@form8, form10::class.java)
                    ...
                    11 -> {
                        ...
                        writeFile(text18.text.toString(), text28.text.toString(), this)
                        read()
                        val form11Activity = Intent(this@form8, form11::class.java)
                    ...
                    12 -> {
                        ...
                        writeFile(text18.text.toString(), text28.text.toString(), this)
                        read()
                        val form12Activity = Intent(this@form8, form12::class.java)
                    ...
                    13 -> {
                        ...
                        writeFile(text18.text.toString(), text28.text.toString(), this)
                        read()
                        val form13Activity = Intent(this@form8, form13::class.java)
                    ...
                    14 -> {
                        ...
                        writeFile(text18.text.toString(), text28.text.toString(), this)
                        read()
                        val form14Activity = Intent(this@form8, form14::class.java)
                    ...
                    15 -> {
                        ...
                        writeFile(text18.text.toString(), text28.text.toString(), this)
                        read()
                        val form15Activity = Intent(this@form8, form15::class.java)
                    ...
                    16 -> {
                        ...
                        writeFile(text18.text.toString(), text28.text.toString(), this)
                        read()
                        val form16Activity = Intent(this@form8, form16::class.java)
                    ...
                    17 -> {
                        ...
                        writeFile(text18.text.toString(), text28.text.toString(), this)
                        read()
                        val form17Activity = Intent(this@form8, form17::class.java)
                    ...
                    18 -> {
                        ...
                        writeFile(text18.text.toString(), text28.text.toString(), this)
                        read()
                        val form18Activity = Intent(this@form8, form18::class.java)
                    ...
                    19 -> {
                        ...
                        writeFile(text18.text.toString(), text28.text.toString(), this)
                        read()
                        val form19Activity = Intent(this@form8, form19::class.java)
                    ...
                    20 -> {
                        ...
                        writeFile(text18.text.toString(), text28.text.toString(), this)
                        read()
                        val form20Activity = Intent(this@form8, form20::class.java)
                    ...
                    21 -> {
                        ...
                        writeFile(text18.text.toString(), text28.text.toString(), this)
                        read()
                        val form21Activity = Intent(this@form8, form21::class.java)
                    ...
                    22 -> {
                        ...
                        writeFile(text18.text.toString(), text28.text.toString(), this)
                        read()
                        val form22Activity = Intent(this@form8, form22::class.java)
    ...
    fun saveData(){
        ...
        jsonObj.put("reponse 1", text18.text.toString())
        jsonObj.put("reponse 2", text28.text.toString())
        val sharedNewAnswer = this.getSharedPreferences("sharedNewAnswer", Context.MODE_PRIVATE) ?: return
        with(sharedNewAnswer.edit()) {
            putString("userResponse7", jsonObj.toString())
            commit()
        }
    }
