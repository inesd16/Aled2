...
class form12 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Switch1 = findViewById(R.id.form12_switch1)
        Switch2 = findViewById(R.id.form12_switch2)
        Switch3 = findViewById(R.id.form12_switch3)
        Switch4 = findViewById(R.id.form12_switch4)
        Switch5 = findViewById(R.id.form12_switch5)
        Go = findViewById(R.id.form12_button1)
        val form = intent
