...
class form15 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Seekbar1 = findViewById(R.id.form15_seekBar1)
        Switch2 = findViewById(R.id.form15_switch2)
        Switch3 = findViewById(R.id.form15_switch3)
        Switch4 = findViewById(R.id.form15_switch4)
        Switch5 = findViewById(R.id.form15_switch5)
        Go = findViewById(R.id.form15_button1)
        val form = intent
