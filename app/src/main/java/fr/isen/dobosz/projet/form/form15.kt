...
class form15 : AppCompatActivity() {
    private var ret1 = 0
        ...
        button.setOnClickListener(object : View.OnClickListener{
            override fun onClick(v: View?) {
                when (ret1 /*Log.d("ret1", extras?.getInt("val").toString())*/) {
                    1 -> {
                        saveData()
                        writeFile(text115.text.toString(), text215.text.toString(), text315.text.toString(), text415.text.toString(), this)
                        read()
                        val form1Activity = Intent(this@form15, form1::class.java)
                    ...
                    2 -> {
                        ...
                        writeFile(text115.text.toString(), text215.text.toString(), text315.text.toString(), text415.text.toString(), this)
                        read()
                        val form2Activity = Intent(this@form15, form2::class.java)
                    ...
                    3 -> {
                        ...
                        writeFile(text115.text.toString(), text215.text.toString(), text315.text.toString(), text415.text.toString(), this)
                        read()
                        val form3Activity = Intent(this@form15, form3::class.java)
                    ...
                    4 -> {
                        ...
                        writeFile(text115.text.toString(), text215.text.toString(), text315.text.toString(), text415.text.toString(), this)
                        read()
                        val form4Activity = Intent(this@form15, form4::class.java)
                    ...
                    5 -> {
                        ...
                        writeFile(text115.text.toString(), text215.text.toString(), text315.text.toString(), text415.text.toString(), this)
                        read()
                        val form5Activity = Intent(this@form15, form5::class.java)
                    ...
                    6 -> {
                        ...
                        writeFile(text115.text.toString(), text215.text.toString(), text315.text.toString(), text415.text.toString(), this)
                        read()
                        val form6Activity = Intent(this@form15, form6::class.java)
                    ...
                    7 -> {
                        ...
                        writeFile(text115.text.toString(), text215.text.toString(), text315.text.toString(), text415.text.toString(), this)
                        read()
                        val form7Activity = Intent(this@form15, form7::class.java)
                    ...
                    8 -> {
                        ...
                        writeFile(text115.text.toString(), text215.text.toString(), text315.text.toString(), text415.text.toString(), this)
                        read()
                        val form8Activity = Intent(this@form15, form8::class.java)
                    ...
                    9 -> {
                        ...
                        writeFile(text115.text.toString(), text215.text.toString(), text315.text.toString(), text415.text.toString(), this)
                        read()
                        val form9Activity = Intent(this@form15, form9::class.java)
                    ...
                    10 -> {
                        ...
                        writeFile(text115.text.toString(), text215.text.toString(), text315.text.toString(), text415.text.toString(), this)
                        read()
                        val form10Activity = Intent(this@form15, form10::class.java)
                    ...
                    11 -> {
                        ...
                        writeFile(text115.text.toString(), text215.text.toString(), text315.text.toString(), text415.text.toString(), this)
                        read()
                        val form11Activity = Intent(this@form15, form11::class.java)
                    ...
                    12 -> {
                        ...
                        writeFile(text115.text.toString(), text215.text.toString(), text315.text.toString(), text415.text.toString(), this)
                        read()
                        val form12Activity = Intent(this@form15, form12::class.java)
                    ...
                    13 -> {
                        ...
                        writeFile(text115.text.toString(), text215.text.toString(), text315.text.toString(), text415.text.toString(), this)
                        read()
                        val form13Activity = Intent(this@form15, form13::class.java)
                    ...
                    14 -> {
                        ...
                        writeFile(text115.text.toString(), text215.text.toString(), text315.text.toString(), text415.text.toString(), this)
                        read()
                        val form14Activity = Intent(this@form15, form14::class.java)
                    ...
                    15 -> {
                        ...
                        writeFile(text115.text.toString(), text215.text.toString(), text315.text.toString(), text415.text.toString(), this)
                        read()
                        val form15Activity = Intent(this@form15, form15::class.java)
                    ...
                    16 -> {
                        ...
                        writeFile(text115.text.toString(), text215.text.toString(), text315.text.toString(), text415.text.toString(), this)
                        read()
                        val form16Activity = Intent(this@form15, form16::class.java)
                    ...
                    17 -> {
                        ...
                        writeFile(text115.text.toString(), text215.text.toString(), text315.text.toString(), text415.text.toString(), this)
                        read()
                        val form17Activity = Intent(this@form15, form17::class.java)
                    ...
                    18 -> {
                        ...
                        writeFile(text115.text.toString(), text215.text.toString(), text315.text.toString(), text415.text.toString(), this)
                        read()
                        val form18Activity = Intent(this@form15, form18::class.java)
                    ...
                    19 -> {
                        ...
                        writeFile(text115.text.toString(), text215.text.toString(), text315.text.toString(), text415.text.toString(), this)
                        read()
                        val form19Activity = Intent(this@form15, form19::class.java)
                    ...
                    20 -> {
                        ...
                        writeFile(text115.text.toString(), text215.text.toString(), text315.text.toString(), text415.text.toString(), this)
                        read()
                        val form20Activity = Intent(this@form15, form20::class.java)
                    ...
                    21 -> {
                        ...
                        writeFile(text115.text.toString(), text215.text.toString(), text315.text.toString(), text415.text.toString(), this)
                        read()
                        val form21Activity = Intent(this@form15, form21::class.java)
                    ...
                    22 -> {
                        ...
                        writeFile(text115.text.toString(), text215.text.toString(), text315.text.toString(), text415.text.toString(), this)
                        read()
                        val form22Activity = Intent(this@form15, form22::class.java)
    ...
    fun saveData(){
        ...
        jsonObj.put("reponse 1", text115.text.toString())
        jsonObj.put("reponse 2", text215.text.toString())
        jsonObj.put("reponse 3", text315.text.toString())
        jsonObj.put("reponse 4", text415.text.toString())
        ...
        with(sharedNewAnswer.edit()) {
            putString("userResponse15", jsonObj.toString())
            commit()
        }
    }
    ...
    fun read() {
        requestPermission(Manifest.permission.READ_EXTERNAL_STORAGE, readESRequestCode) {
            ...
            val file = File(dir, "answerForm15.txt")
