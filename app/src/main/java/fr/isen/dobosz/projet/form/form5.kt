...
class form5 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Seekbar2 = findViewById(R.id.form5_seekBar2)
        Switch1 = findViewById(R.id.form5_switch1)
        Switch3 = findViewById(R.id.form5_switch3)
        Switch4 = findViewById(R.id.form5_switch4)
        Switch5 = findViewById(R.id.form5_switch5)
        Go = findViewById(R.id.form5_button1)
        val form = intent
