...
class form20 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Seekbar1 = findViewById(R.id.form20_seekBar1)
        Seekbar2 = findViewById(R.id.form20_seekBar2)
        Switch3 = findViewById(R.id.form20_switch3)
        Switch4 = findViewById(R.id.form20_switch4)
        Switch5 = findViewById(R.id.form20_switch5)
        Go = findViewById(R.id.form20_button1)
        val form = intent
