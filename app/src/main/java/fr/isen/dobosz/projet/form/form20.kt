...
import kotlinx.android.synthetic.main.activity_form20.*
import kotlinx.android.synthetic.main.activity_form20.button
...
class form20 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_form20)
            ...
            override fun onClick(v: View?) {
                when (Log.d("ret1", extras?.getInt("val").toString())) {
                    1 -> {
                        ...
                        read()
                        val form1Activity = Intent(this@form20, form1::class.java)
                    ...
                    2 -> {
                        ...
                        writeFile(text120.text.toString(), text220.text.toString(), text320.text.toString(), this)
                        read()
                        val form2Activity = Intent(this@form20, form2::class.java)
                    ...
                    3 -> {
                        ...
                        writeFile(text120.text.toString(), text220.text.toString(), text320.text.toString(), this)
                        read()
                        val form3Activity = Intent(this@form20, form3::class.java)
                    ...
                    4 -> {
                        ...
                        writeFile(text120.text.toString(), text220.text.toString(), text320.text.toString(), this)
                        read()
                        val form4Activity = Intent(this@form20, form4::class.java)
                    ...
                    5 -> {
                        ...
                        writeFile(text120.text.toString(), text220.text.toString(), text320.text.toString(), this)
                        read()
                        val form5Activity = Intent(this@form20, form5::class.java)
                    ...
                    6 -> {
                        ...
                        writeFile(text120.text.toString(), text220.text.toString(), text320.text.toString(), this)
                        read()
                        val form6Activity = Intent(this@form20, form6::class.java)
                    ...
                    7 -> {
                        ...
                        writeFile(text120.text.toString(), text220.text.toString(), text320.text.toString(), this)
                        read()
                        val form7Activity = Intent(this@form20, form7::class.java)
                    ...
                    8 -> {
                        ...
                        writeFile(text120.text.toString(), text220.text.toString(), text320.text.toString(), this)
                        read()
                        val form8Activity = Intent(this@form20, form8::class.java)
                    ...
                    9 -> {
                        ...
                        writeFile(text120.text.toString(), text220.text.toString(), text320.text.toString(), this)
                        read()
                        val form9Activity = Intent(this@form20, form9::class.java)
                    ...
                    10 -> {
                        ...
                        writeFile(text120.text.toString(), text220.text.toString(), text320.text.toString(), this)
                        read()
                        val form10Activity = Intent(this@form20, form10::class.java)
                    ...
                    11 -> {
                        ...
                        writeFile(text120.text.toString(), text220.text.toString(), text320.text.toString(), this)
                        read()
                        val form11Activity = Intent(this@form20, form11::class.java)
                    ...
                    12 -> {
                        ...
                        writeFile(text120.text.toString(), text220.text.toString(), text320.text.toString(), this)
                        read()
                        val form12Activity = Intent(this@form20, form12::class.java)
                    ...
                    13 -> {
                        ...
                        writeFile(text120.text.toString(), text220.text.toString(), text320.text.toString(), this)
                        read()
                        val form13Activity = Intent(this@form20, form13::class.java)
                    ...
                    14 -> {
                        ...
                        writeFile(text120.text.toString(), text220.text.toString(), text320.text.toString(), this)
                        read()
                        val form14Activity = Intent(this@form20, form14::class.java)
                    ...
                    15 -> {
                        ...
                        writeFile(text120.text.toString(), text220.text.toString(), text320.text.toString(), this)
                        read()
                        val form15Activity = Intent(this@form20, form15::class.java)
                    ...
                    16 -> {
                        ...
                        writeFile(text120.text.toString(), text220.text.toString(), text320.text.toString(), this)
                        read()
                        val form16Activity = Intent(this@form20, form16::class.java)
                    ...
                    17 -> {
                        ...
                        writeFile(text120.text.toString(), text220.text.toString(), text320.text.toString(), this)
                        read()
                        val form17Activity = Intent(this@form20, form17::class.java)
                    ...
                    18 -> {
                        ...
                        writeFile(text120.text.toString(), text220.text.toString(), text320.text.toString(), this)
                        read()
                        val form18Activity = Intent(this@form20, form18::class.java)
                    ...
                    19 -> {
                        ...
                        writeFile(text120.text.toString(), text220.text.toString(), text320.text.toString(), this)
                        read()
                        val form19Activity = Intent(this@form20, form19::class.java)
                    ...
                    20 -> {
                        ...
                        writeFile(text120.text.toString(), text220.text.toString(), text320.text.toString(), this)
                        read()
                        val form20Activity = Intent(this@form20, form20::class.java)
                    ...
                    21 -> {
                        ...
                        writeFile(text120.text.toString(), text220.text.toString(), text320.text.toString(), this)
                        read()
                        val form21Activity = Intent(this@form20, form21::class.java)
                    ...
                    22 -> {
                        ...
                        writeFile(text120.text.toString(), text220.text.toString(), text320.text.toString(), this)
                        read()
                        val form22Activity = Intent(this@form20, form22::class.java)
    ...
    fun saveData(){
        ...
        jsonObj.put("reponse 1", text120.text.toString())
        jsonObj.put("reponse 2", text220.text.toString())
        jsonObj.put("reponse 3", text320.text.toString())
        val sharedNewAnswer = this.getSharedPreferences("sharedNewAnswer", Context.MODE_PRIVATE) ?: return
        with(sharedNewAnswer.edit()) {
            putString("userResponse20", jsonObj.toString())
            commit()
        }
    }
    ...
    fun read() {
        requestPermission(Manifest.permission.READ_EXTERNAL_STORAGE, readESRequestCode) {
            ...
            val file = File(dir, "answerForm20.txt")
