...
class form16 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Seekbar1 = findViewById(R.id.form16_seekBar1)
        Seekbar2 = findViewById(R.id.form16_seekBar2)
        Switch3 = findViewById(R.id.form16_switch3)
        Switch4 = findViewById(R.id.form16_switch4)
        Switch5 = findViewById(R.id.form16_switch5)
        Go = findViewById(R.id.form16_button1)
        val form = intent
