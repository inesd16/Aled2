...
class form16 : AppCompatActivity() {
        ...
        button.setOnClickListener(object : View.OnClickListener{
            override fun onClick(v: View?) {
                when (ret1 /*Log.d("ret1", extras?.getInt("val").toString())*/) {
                    1 -> {
                        saveData()
                        writeFile(text116.text.toString(), text216.text.toString(), text316.text.toString(), this)
                        read()
                        val form1Activity = Intent(this@form16, form1::class.java)
                    ...
                    2 -> {
                        ...
                        writeFile(text116.text.toString(), text216.text.toString(), text316.text.toString(), this)
                        read()
                        val form2Activity = Intent(this@form16, form2::class.java)
                    ...
                    3 -> {
                        ...
                        writeFile(text116.text.toString(), text216.text.toString(), text316.text.toString(), this)
                        read()
                        val form3Activity = Intent(this@form16, form3::class.java)
                    ...
                    4 -> {
                        ...
                        writeFile(text116.text.toString(), text216.text.toString(), text316.text.toString(), this)
                        read()
                        val form4Activity = Intent(this@form16, form4::class.java)
                    ...
                    5 -> {
                        ...
                        writeFile(text116.text.toString(), text216.text.toString(), text316.text.toString(), this)
                        read()
                        val form5Activity = Intent(this@form16, form5::class.java)
                    ...
                    6 -> {
                        ...
                        writeFile(text116.text.toString(), text216.text.toString(), text316.text.toString(), this)
                        read()
                        val form6Activity = Intent(this@form16, form6::class.java)
                    ...
                    7 -> {
                        ...
                        writeFile(text116.text.toString(), text216.text.toString(), text316.text.toString(), this)
                        read()
                        val form7Activity = Intent(this@form16, form7::class.java)
                    ...
                    8 -> {
                        ...
                        writeFile(text116.text.toString(), text216.text.toString(), text316.text.toString(), this)
                        read()
                        val form8Activity = Intent(this@form16, form8::class.java)
                    ...
                    9 -> {
                        ...
                        writeFile(text116.text.toString(), text216.text.toString(), text316.text.toString(), this)
                        read()
                        val form9Activity = Intent(this@form16, form9::class.java)
                    ...
                    10 -> {
                        ...
                        writeFile(text116.text.toString(), text216.text.toString(), text316.text.toString(), this)
                        read()
                        val form10Activity = Intent(this@form16, form10::class.java)
                    ...
                    11 -> {
                        ...
                        writeFile(text116.text.toString(), text216.text.toString(), text316.text.toString(), this)
                        read()
                        val form11Activity = Intent(this@form16, form11::class.java)
                    ...
                    12 -> {
                        ...
                        writeFile(text116.text.toString(), text216.text.toString(), text316.text.toString(), this)
                        read()
                        val form12Activity = Intent(this@form16, form12::class.java)
                    ...
                    13 -> {
                        ...
                        writeFile(text116.text.toString(), text216.text.toString(), text316.text.toString(), this)
                        read()
                        val form13Activity = Intent(this@form16, form13::class.java)
                    ...
                    14 -> {
                        ...
                        writeFile(text116.text.toString(), text216.text.toString(), text316.text.toString(), this)
                        read()
                        val form14Activity = Intent(this@form16, form14::class.java)
                    ...
                    15 -> {
                        ...
                        writeFile(text116.text.toString(), text216.text.toString(), text316.text.toString(), this)
                        read()
                        val form15Activity = Intent(this@form16, form15::class.java)
                    ...
                    16 -> {
                        ...
                        writeFile(text116.text.toString(), text216.text.toString(), text316.text.toString(), this)
                        read()
                        val form16Activity = Intent(this@form16, form16::class.java)
                    ...
                    17 -> {
                        ...
                        writeFile(text116.text.toString(), text216.text.toString(), text316.text.toString(), this)
                        read()
                        val form17Activity = Intent(this@form16, form17::class.java)
                    ...
                    18 -> {
                        ...
                        writeFile(text116.text.toString(), text216.text.toString(), text316.text.toString(), this)
                        read()
                        val form18Activity = Intent(this@form16, form18::class.java)
                    ...
                    19 -> {
                        ...
                        writeFile(text116.text.toString(), text216.text.toString(), text316.text.toString(), this)
                        read()
                        val form19Activity = Intent(this@form16, form19::class.java)
                    ...
                    20 -> {
                        ...
                        writeFile(text116.text.toString(), text216.text.toString(), text316.text.toString(), this)
                        read()
                        val form20Activity = Intent(this@form16, form20::class.java)
                    ...
                    21 -> {
                        ...
                        writeFile(text116.text.toString(), text216.text.toString(), text316.text.toString(), this)
                        read()
                        val form21Activity = Intent(this@form16, form21::class.java)
                    ...
                    22 -> {
                        ...
                        writeFile(text116.text.toString(), text216.text.toString(), text316.text.toString(), this)
                        read()
                        val form22Activity = Intent(this@form16, form22::class.java)
    ...
    fun saveData(){
        ...
        jsonObj.put("reponse 1", text116.text.toString())
        jsonObj.put("reponse 2", text216.text.toString())
        jsonObj.put("reponse 3", text316.text.toString())
        ...
        with(sharedNewAnswer.edit()) {
            putString("userResponse16", jsonObj.toString())
            commit()
        }
    }
