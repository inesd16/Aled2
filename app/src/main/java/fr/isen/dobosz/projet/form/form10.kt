...
class form10 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Seekbar1 = findViewById(R.id.form10_seekBar1)
        Switch2 = findViewById(R.id.form10_switch2)
        Switch3 = findViewById(R.id.form10_switch3)
        Switch4 = findViewById(R.id.form10_switch4)
        Switch5 = findViewById(R.id.form10_switch5)
        Go = findViewById(R.id.form10_button1)
        val form = intent
