...
class form10 : AppCompatActivity() {
        ...
        button.setOnClickListener(object : View.OnClickListener{
            override fun onClick(v: View?) {
                when (ret1/*Log.d("ret1", extras?.getInt("val").toString())*/) {
                    1 -> {
                        saveData()
                        writeFile(text110.text.toString(), text210.text.toString(), text310.text.toString(), text410.text.toString(), this)
                        read()
                        val form1Activity = Intent(this@form10, form1::class.java)
                    ...
                    2 -> {
                        ...
                        writeFile(text110.text.toString(), text210.text.toString(), text310.text.toString(), text410.text.toString(), this)
                        read()
                        val form2Activity = Intent(this@form10, form2::class.java)
                    ...
                    3 -> {
                        ...
                        writeFile(text110.text.toString(), text210.text.toString(), text310.text.toString(), text410.text.toString(), this)
                        read()
                        val form3Activity = Intent(this@form10, form3::class.java)
                    ...
                    4 -> {
                        ...
                        writeFile(text110.text.toString(), text210.text.toString(), text310.text.toString(), text410.text.toString(), this)
                        read()
                        val form4Activity = Intent(this@form10, form4::class.java)
                    ...
                    5 -> {
                        ...
                        writeFile(text110.text.toString(), text210.text.toString(), text310.text.toString(), text410.text.toString(), this)
                        read()
                        val form5Activity = Intent(this@form10, form5::class.java)
                    ...
                    6 -> {
                        ...
                        writeFile(text110.text.toString(), text210.text.toString(), text310.text.toString(), text410.text.toString(), this)
                        read()
                        val form6Activity = Intent(this@form10, form6::class.java)
                    ...
                    7 -> {
                        ...
                        writeFile(text110.text.toString(), text210.text.toString(), text310.text.toString(), text410.text.toString(), this)
                        read()
                        val form7Activity = Intent(this@form10, form7::class.java)
                    ...
                    8 -> {
                        ...
                        writeFile(text110.text.toString(), text210.text.toString(), text310.text.toString(), text410.text.toString(), this)
                        read()
                        val form8Activity = Intent(this@form10, form8::class.java)
                    ...
                    9 -> {
                        ...
                        writeFile(text110.text.toString(), text210.text.toString(), text310.text.toString(), text410.text.toString(), this)
                        read()
                        val form9Activity = Intent(this@form10, form9::class.java)
                    ...
                    10 -> {
                        ...
                        writeFile(text110.text.toString(), text210.text.toString(), text310.text.toString(), text410.text.toString(), this)
                        read()
                        val form10Activity = Intent(this@form10, form10::class.java)
                    ...
                    11 -> {
                        ...
                        writeFile(text110.text.toString(), text210.text.toString(), text310.text.toString(), text410.text.toString(), this)
                        read()
                        val form11Activity = Intent(this@form10, form11::class.java)
                    ...
                    12 -> {
                        ...
                        writeFile(text110.text.toString(), text210.text.toString(), text310.text.toString(), text410.text.toString(), this)
                        read()
                        val form12Activity = Intent(this@form10, form12::class.java)
                    ...
                    13 -> {
                        ...
                        writeFile(text110.text.toString(), text210.text.toString(), text310.text.toString(), text410.text.toString(), this)
                        read()
                        val form13Activity = Intent(this@form10, form13::class.java)
                    ...
                    14 -> {
                        ...
                        writeFile(text110.text.toString(), text210.text.toString(), text310.text.toString(), text410.text.toString(), this)
                        read()
                        val form14Activity = Intent(this@form10, form14::class.java)
                    ...
                    15 -> {
                        ...
                        writeFile(text110.text.toString(), text210.text.toString(), text310.text.toString(), text410.text.toString(), this)
                        read()
                        val form15Activity = Intent(this@form10, form15::class.java)
                    ...
                    16 -> {
                        ...
                        writeFile(text110.text.toString(), text210.text.toString(), text310.text.toString(), text410.text.toString(), this)
                        read()
                        val form16Activity = Intent(this@form10, form16::class.java)
                    ...
                    17 -> {
                        ...
                        writeFile(text110.text.toString(), text210.text.toString(), text310.text.toString(), text410.text.toString(), this)
                        read()
                        val form17Activity = Intent(this@form10, form17::class.java)
                    ...
                    18 -> {
                        ...
                        writeFile(text110.text.toString(), text210.text.toString(), text310.text.toString(), text410.text.toString(), this)
                        read()
                        val form18Activity = Intent(this@form10, form18::class.java)
                    ...
                    19 -> {
                        ...
                        writeFile(text110.text.toString(), text210.text.toString(), text310.text.toString(), text410.text.toString(), this)
                        read()
                        val form19Activity = Intent(this@form10, form19::class.java)
                    ...
                    20 -> {
                        ...
                        writeFile(text110.text.toString(), text210.text.toString(), text310.text.toString(), text410.text.toString(), this)
                        read()
                        val form20Activity = Intent(this@form10, form20::class.java)
                    ...
                    21 -> {
                        ...
                        writeFile(text110.text.toString(), text210.text.toString(), text310.text.toString(), text410.text.toString(), this)
                        read()
                        val form21Activity = Intent(this@form10, form21::class.java)
                    ...
                    22 -> {
                        ...
                        writeFile(text110.text.toString(), text210.text.toString(), text310.text.toString(), text410.text.toString(), this)
                        read()
                        val form22Activity = Intent(this@form10, form22::class.java)
    ...
    fun saveData(){
        ...
        jsonObj.put("reponse 1", text110.text.toString())
        jsonObj.put("reponse 2", text210.text.toString())
        jsonObj.put("reponse 3", text310.text.toString())
        jsonObj.put("reponse 4", text410.text.toString())
        ...
        with(sharedNewAnswer.edit()) {
            putString("userResponse10", jsonObj.toString())
            commit()
        }
    }
