...
import kotlinx.android.synthetic.main.activity_form6.button
...
class form6 : AppCompatActivity() {
            ...
            override fun onClick(v: View?) {
                when (Log.d("ret1", extras?.getInt("val").toString())) {
                    ...
                    2 -> {
                        ...
                        writeFile(text16.text.toString(), text26.text.toString(), text36.text.toString(), text46.text.toString(), this)
                        read()
                        val form2Activity = Intent(this@form6, form2::class.java)
                    ...
                    3 -> {
                        ...
                        writeFile(text16.text.toString(), text26.text.toString(), text36.text.toString(), text46.text.toString(), this)
                        read()
                        val form3Activity = Intent(this@form6, form3::class.java)
                    ...
                    4 -> {
                        ...
                        writeFile(text16.text.toString(), text26.text.toString(), text36.text.toString(), text46.text.toString(), this)
                        read()
                        val form4Activity = Intent(this@form6, form4::class.java)
                    ...
                    5 -> {
                        ...
                        writeFile(text16.text.toString(), text26.text.toString(), text36.text.toString(), text46.text.toString(), this)
                        read()
                        val form5Activity = Intent(this@form6, form5::class.java)
                    ...
                    6 -> {
                        ...
                        writeFile(text16.text.toString(), text26.text.toString(), text36.text.toString(), text46.text.toString(), this)
                        read()
                        val form6Activity = Intent(this@form6, form6::class.java)
                    ...
                    7 -> {
                        ...
                        writeFile(text16.text.toString(), text26.text.toString(), text36.text.toString(), text46.text.toString(), this)
                        read()
                        val form7Activity = Intent(this@form6, form7::class.java)
                    ...
                    8 -> {
                        ...
                        writeFile(text16.text.toString(), text26.text.toString(), text36.text.toString(), text46.text.toString(), this)
                        read()
                        val form8Activity = Intent(this@form6, form8::class.java)
                    ...
                    9 -> {
                        ...
                        writeFile(text16.text.toString(), text26.text.toString(), text36.text.toString(), text46.text.toString(), this)
                        read()
                        val form9Activity = Intent(this@form6, form9::class.java)
                    ...
                    10 -> {
                        ...
                        writeFile(text16.text.toString(), text26.text.toString(), text36.text.toString(), text46.text.toString(), this)
                        read()
                        val form10Activity = Intent(this@form6, form10::class.java)
                    ...
                    11 -> {
                        ...
                        writeFile(text16.text.toString(), text26.text.toString(), text36.text.toString(), text46.text.toString(), this)
                        read()
                        val form11Activity = Intent(this@form6, form11::class.java)
                    ...
                    12 -> {
                        ...
                        writeFile(text16.text.toString(), text26.text.toString(), text36.text.toString(), text46.text.toString(), this)
                        read()
                        val form12Activity = Intent(this@form6, form12::class.java)
                    ...
                    13 -> {
                        ...
                        writeFile(text16.text.toString(), text26.text.toString(), text36.text.toString(), text46.text.toString(), this)
                        read()
                        val form13Activity = Intent(this@form6, form13::class.java)
                    ...
                    14 -> {
                        ...
                        writeFile(text16.text.toString(), text26.text.toString(), text36.text.toString(), text46.text.toString(), this)
                        read()
                        val form14Activity = Intent(this@form6, form14::class.java)
                    ...
                    15 -> {
                        ...
                        writeFile(text16.text.toString(), text26.text.toString(), text36.text.toString(), text46.text.toString(), this)
                        read()
                        val form15Activity = Intent(this@form6, form15::class.java)
                    ...
                    16 -> {
                        ...
                        writeFile(text16.text.toString(), text26.text.toString(), text36.text.toString(), text46.text.toString(), this)
                        read()
                        val form16Activity = Intent(this@form6, form16::class.java)
                    ...
                    17 -> {
                        ...
                        writeFile(text16.text.toString(), text26.text.toString(), text36.text.toString(), text46.text.toString(), this)
                        read()
                        val form17Activity = Intent(this@form6, form17::class.java)
                    ...
                    18 -> {
                        ...
                        writeFile(text16.text.toString(), text26.text.toString(), text36.text.toString(), text46.text.toString(), this)
                        read()
                        val form18Activity = Intent(this@form6, form18::class.java)
                    ...
                    19 -> {
                        ...
                        writeFile(text16.text.toString(), text26.text.toString(), text36.text.toString(), text46.text.toString(), this)
                        read()
                        val form19Activity = Intent(this@form6, form19::class.java)
                    ...
                    20 -> {
                        ...
                        writeFile(text16.text.toString(), text26.text.toString(), text36.text.toString(), text46.text.toString(), this)
                        read()
                        val form20Activity = Intent(this@form6, form20::class.java)
                    ...
                    21 -> {
                        ...
                        writeFile(text16.text.toString(), text26.text.toString(), text36.text.toString(), text46.text.toString(), this)
                        read()
                        val form21Activity = Intent(this@form6, form21::class.java)
                    ...
                    22 -> {
                        ...
                        writeFile(text16.text.toString(), text26.text.toString(), text36.text.toString(), text46.text.toString(), this)
                        read()
                        val form22Activity = Intent(this@form6, form22::class.java)
    ...
    fun saveData(){
        ...
        jsonObj.put("reponse 1", text16.text.toString())
        jsonObj.put("reponse 2", text26.text.toString())
        jsonObj.put("reponse 3", text36.text.toString())
        jsonObj.put("reponse 4", text46.text.toString())
        ...
        with(sharedNewAnswer.edit()) {
            putString("userResponse6", jsonObj.toString())
            commit()
        }
    }
    ...
    fun read() {
        requestPermission(Manifest.permission.READ_EXTERNAL_STORAGE, readESRequestCode) {
            ...
            val file = File(dir, "answerForm6.txt")
