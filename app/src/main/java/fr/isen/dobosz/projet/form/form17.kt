...
class form17 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Seekbar1 = findViewById(R.id.form17_seekBar1)
        Seekbar2 = findViewById(R.id.form17_seekBar2)
        Switch3 = findViewById(R.id.form17_switch3)
        Switch4 = findViewById(R.id.form17_switch4)
        Switch5 = findViewById(R.id.form17_switch5)
        Go = findViewById(R.id.form17_button1)
        val form = intent
