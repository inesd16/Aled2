...
import kotlinx.android.synthetic.main.activity_form17.button
...
class form17 : AppCompatActivity() {
        ...
        button.setOnClickListener(object : View.OnClickListener{
            override fun onClick(v: View?) {
                when (Log.d("ret1", extras?.getInt("val").toString())) {
                    1 -> {
                        saveData()
                        writeFile(text117.text.toString(), text217.text.toString(), text317.text.toString(), this)
                        read()
                        val form1Activity = Intent(this@form17, form1::class.java)
                    ...
                    2 -> {
                        ...
                        writeFile(text117.text.toString(), text217.text.toString(), text317.text.toString(), this)
                        read()
                        val form2Activity = Intent(this@form17, form2::class.java)
                    ...
                    3 -> {
                        ...
                        writeFile(text117.text.toString(), text217.text.toString(), text317.text.toString(), this)
                        read()
                        val form3Activity = Intent(this@form17, form3::class.java)
                    ...
                    4 -> {
                        ...
                        writeFile(text117.text.toString(), text217.text.toString(), text317.text.toString(), this)
                        read()
                        val form4Activity = Intent(this@form17, form4::class.java)
                    ...
                    5 -> {
                        ...
                        writeFile(text117.text.toString(), text217.text.toString(), text317.text.toString(), this)
                        read()
                        val form5Activity = Intent(this@form17, form5::class.java)
                    ...
                    6 -> {
                        ...
                        writeFile(text117.text.toString(), text217.text.toString(), text317.text.toString(), this)
                        read()
                        val form6Activity = Intent(this@form17, form6::class.java)
                    ...
                    7 -> {
                        ...
                        writeFile(text117.text.toString(), text217.text.toString(), text317.text.toString(), this)
                        read()
                        val form7Activity = Intent(this@form17, form7::class.java)
                    ...
                    8 -> {
                        ...
                        writeFile(text117.text.toString(), text217.text.toString(), text317.text.toString(), this)
                        read()
                        val form8Activity = Intent(this@form17, form8::class.java)
                    ...
                    9 -> {
                        ...
                        writeFile(text117.text.toString(), text217.text.toString(), text317.text.toString(), this)
                        read()
                        val form9Activity = Intent(this@form17, form9::class.java)
                    ...
                    10 -> {
                        ...
                        writeFile(text117.text.toString(), text217.text.toString(), text317.text.toString(), this)
                        read()
                        val form10Activity = Intent(this@form17, form10::class.java)
                    ...
                    11 -> {
                        ...
                        writeFile(text117.text.toString(), text217.text.toString(), text317.text.toString(), this)
                        read()
                        val form11Activity = Intent(this@form17, form11::class.java)
                    ...
                    12 -> {
                        ...
                        writeFile(text117.text.toString(), text217.text.toString(), text317.text.toString(), this)
                        read()
                        val form12Activity = Intent(this@form17, form12::class.java)
                    ...
                    13 -> {
                        ...
                        writeFile(text117.text.toString(), text217.text.toString(), text317.text.toString(), this)
                        read()
                        val form13Activity = Intent(this@form17, form13::class.java)
                    ...
                    14 -> {
                        ...
                        writeFile(text117.text.toString(), text217.text.toString(), text317.text.toString(), this)
                        read()
                        val form14Activity = Intent(this@form17, form14::class.java)
                    ...
                    15 -> {
                        ...
                        writeFile(text117.text.toString(), text217.text.toString(), text317.text.toString(), this)
                        read()
                        val form15Activity = Intent(this@form17, form15::class.java)
                    ...
                    16 -> {
                        ...
                        writeFile(text117.text.toString(), text217.text.toString(), text317.text.toString(), this)
                        read()
                        val form16Activity = Intent(this@form17, form16::class.java)
                    ...
                    17 -> {
                        ...
                        writeFile(text117.text.toString(), text217.text.toString(), text317.text.toString(), this)
                        read()
                        val form17Activity = Intent(this@form17, form17::class.java)
                    ...
                    18 -> {
                        ...
                        writeFile(text117.text.toString(), text217.text.toString(), text317.text.toString(), this)
                        read()
                        val form18Activity = Intent(this@form17, form18::class.java)
                    ...
                    19 -> {
                        ...
                        writeFile(text117.text.toString(), text217.text.toString(), text317.text.toString(), this)
                        read()
                        val form19Activity = Intent(this@form17, form19::class.java)
                    ...
                    20 -> {
                        ...
                        writeFile(text117.text.toString(), text217.text.toString(), text317.text.toString(), this)
                        read()
                        val form20Activity = Intent(this@form17, form20::class.java)
                    ...
                    21 -> {
                        ...
                        writeFile(text117.text.toString(), text217.text.toString(), text317.text.toString(), this)
                        read()
                        val form21Activity = Intent(this@form17, form21::class.java)
                    ...
                    22 -> {
                        ...
                        writeFile(text117.text.toString(), text217.text.toString(), text317.text.toString(), this)
                        read()
                        val form22Activity = Intent(this@form17, form22::class.java)
    ...
    fun saveData(){
        ...
        jsonObj.put("reponse 1", text117.text.toString())
        jsonObj.put("reponse 2", text217.text.toString())
        jsonObj.put("reponse 3", text317.text.toString())
        val sharedNewAnswer = this.getSharedPreferences("sharedNewAnswer", Context.MODE_PRIVATE) ?: return
        with(sharedNewAnswer.edit()) {
            putString("userResponse17", jsonObj.toString())
            commit()
        }
    }
    ...
    fun read() {
        requestPermission(Manifest.permission.READ_EXTERNAL_STORAGE, readESRequestCode) {
            ...
            val file = File(dir, "answerForm17.txt")
