...
class form9 : AppCompatActivity() {
        ...
        button.setOnClickListener(object : View.OnClickListener{
            override fun onClick(v: View?) {
                when (ret1 /*Log.d("ret1", extras?.getInt("val").toString())*/) {
                    1 -> {
                        saveData()
                        writeFile(text19.text.toString(), text29.text.toString(), text39.text.toString(), this)
                        read()
    ...
    fun saveData(){
        ...
        jsonObj.put("reponse 2", text29.text.toString())
        jsonObj.put("reponse 3", text39.text.toString())
        ...
        with(sharedNewAnswer.edit()) {
            putString("userResponse9", jsonObj.toString())
            commit()
        }
    }
    ...
    fun read() {
        requestPermission(Manifest.permission.READ_EXTERNAL_STORAGE, readESRequestCode) {
            ...
            val file = File(dir, "answerForm9.txt")
