...
import kotlinx.android.synthetic.main.activity_form13.button
...
class form13 : AppCompatActivity() {
        ...
        button.setOnClickListener(object : View.OnClickListener{
            override fun onClick(v: View?) {
                when (Log.d("ret1", extras?.getInt("val").toString())) {
                    1 -> {
                        saveData()
                        writeFile(text113.text.toString(), text213.text.toString(), text313.text.toString(), text413.text.toString(), this)
                        read()
                        val form1Activity = Intent(this@form13, form1::class.java)
                    ...
                    2 -> {
                        ...
                        writeFile(text113.text.toString(), text213.text.toString(), text313.text.toString(), text413.text.toString(), this)
                        read()
                        val form2Activity = Intent(this@form13, form2::class.java)
                    ...
                    3 -> {
                        ...
                        writeFile(text113.text.toString(), text213.text.toString(), text313.text.toString(), text413.text.toString(), this)
                        read()
                        val form3Activity = Intent(this@form13, form3::class.java)
                    ...
                    4 -> {
                        ...
                        writeFile(text113.text.toString(), text213.text.toString(), text313.text.toString(), text413.text.toString(), this)
                        read()
                        val form4Activity = Intent(this@form13, form4::class.java)
                    ...
                    5 -> {
                        ...
                        writeFile(text113.text.toString(), text213.text.toString(), text313.text.toString(), text413.text.toString(), this)
                        read()
                        val form5Activity = Intent(this@form13, form5::class.java)
                    ...
                    6 -> {
                        ...
                        writeFile(text113.text.toString(), text213.text.toString(), text313.text.toString(), text413.text.toString(), this)
                        read()
                        val form6Activity = Intent(this@form13, form6::class.java)
                    ...
                    7 -> {
                        ...
                        writeFile(text113.text.toString(), text213.text.toString(), text313.text.toString(), text413.text.toString(), this)
                        read()
                        val form7Activity = Intent(this@form13, form7::class.java)
                    ...
                    8 -> {
                        ...
                        writeFile(text113.text.toString(), text213.text.toString(), text313.text.toString(), text413.text.toString(), this)
                        read()
                        val form8Activity = Intent(this@form13, form8::class.java)
                    ...
                    9 -> {
                        ...
                        writeFile(text113.text.toString(), text213.text.toString(), text313.text.toString(), text413.text.toString(), this)
                        read()
                        val form9Activity = Intent(this@form13, form9::class.java)
                    ...
                    10 -> {
                        ...
                        writeFile(text113.text.toString(), text213.text.toString(), text313.text.toString(), text413.text.toString(), this)
                        read()
                        val form10Activity = Intent(this@form13, form10::class.java)
                    ...
                    11 -> {
                        ...
                        writeFile(text113.text.toString(), text213.text.toString(), text313.text.toString(), text413.text.toString(), this)
                        read()
                        val form11Activity = Intent(this@form13, form11::class.java)
                    ...
                    12 -> {
                        ...
                        writeFile(text113.text.toString(), text213.text.toString(), text313.text.toString(), text413.text.toString(), this)
                        read()
                        val form12Activity = Intent(this@form13, form12::class.java)
                    ...
                    13 -> {
                        ...
                        writeFile(text113.text.toString(), text213.text.toString(), text313.text.toString(), text413.text.toString(), this)
                        read()
                        val form13Activity = Intent(this@form13, form13::class.java)
                    ...
                    14 -> {
                        ...
                        writeFile(text113.text.toString(), text213.text.toString(), text313.text.toString(), text413.text.toString(), this)
                        read()
                        val form14Activity = Intent(this@form13, form14::class.java)
                    ...
                    15 -> {
                        ...
                        writeFile(text113.text.toString(), text213.text.toString(), text313.text.toString(), text413.text.toString(), this)
                        read()
                        val form15Activity = Intent(this@form13, form15::class.java)
                    ...
                    16 -> {
                        ...
                        writeFile(text113.text.toString(), text213.text.toString(), text313.text.toString(), text413.text.toString(), this)
                        read()
                        val form16Activity = Intent(this@form13, form16::class.java)
                    ...
                    17 -> {
                        ...
                        writeFile(text113.text.toString(), text213.text.toString(), text313.text.toString(), text413.text.toString(), this)
                        read()
                        val form17Activity = Intent(this@form13, form17::class.java)
                    ...
                    18 -> {
                        ...
                        writeFile(text113.text.toString(), text213.text.toString(), text313.text.toString(), text413.text.toString(), this)
                        read()
                        val form18Activity = Intent(this@form13, form18::class.java)
                    ...
                    19 -> {
                        ...
                        writeFile(text113.text.toString(), text213.text.toString(), text313.text.toString(), text413.text.toString(), this)
                        read()
                        val form19Activity = Intent(this@form13, form19::class.java)
                    ...
                    20 -> {
                        ...
                        writeFile(text113.text.toString(), text213.text.toString(), text313.text.toString(), text413.text.toString(), this)
                        read()
                        val form20Activity = Intent(this@form13, form20::class.java)
                    ...
                    21 -> {
                        ...
                        writeFile(text113.text.toString(), text213.text.toString(), text313.text.toString(), text413.text.toString(), this)
                        read()
                        val form21Activity = Intent(this@form13, form21::class.java)
                    ...
                    22 -> {
                        ...
                        writeFile(text113.text.toString(), text213.text.toString(), text313.text.toString(), text413.text.toString(), this)
                        read()
                        val form22Activity = Intent(this@form13, form22::class.java)
    ...
    fun saveData(){
        ...
        jsonObj.put("reponse 1", text113.text.toString())
        jsonObj.put("reponse 2", text213.text.toString())
        jsonObj.put("reponse 3", text313.text.toString())
        jsonObj.put("reponse 4", text413.text.toString())
        ...
        with(sharedNewAnswer.edit()) {
            putString("userResponse13", jsonObj.toString())
            commit()
        }
    }
    ...
    fun read() {
        requestPermission(Manifest.permission.READ_EXTERNAL_STORAGE, readESRequestCode) {
            ...
            val file = File(dir, "answerForm13.txt")
