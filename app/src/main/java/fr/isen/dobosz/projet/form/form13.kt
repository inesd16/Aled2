...
class form13 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Seekbar1 = findViewById(R.id.form13_seekBar1)
        Switch2 = findViewById(R.id.form13_switch2)
        Switch3 = findViewById(R.id.form13_switch3)
        Switch4 = findViewById(R.id.form13_switch4)
        Switch5 = findViewById(R.id.form13_switch5)
        Go = findViewById(R.id.form13_button1)
        val form = intent
